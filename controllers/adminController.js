...
module.exports = {
  ...
  addFeature: async (req, res) => {
    ...
    try {
      ...
      await item.save();
      req.flash('alertMessage', 'Success Add New Feature');
      req.flash('alertStatus', 'success');
      res.redirect(`/admin/item/show-detail-item/${itemId}`);
    } catch (error) {
      req.flash('alertMessage', `${error.message}`);
  ...
  actionConfirmation: async (req, res) => {
    ...
    try {
      ...
      await booking.save();
      req.flash('alertMessage', 'Success Update Payments Confirmation');
      req.flash('alertStatus', 'success');
  ...
  actionReject: async (req, res) => {
    ...
    try {
      ...
      await booking.save();
      req.flash('alertMessage', 'Success Update Payments Rejection');
      req.flash('alertStatus', 'success');
      res.redirect(`/admin/booking/${id}`);
    } catch (error) {
      res.redirect(`/admin/booking/${id}`);
